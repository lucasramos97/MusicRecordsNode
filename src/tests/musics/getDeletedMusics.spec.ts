...
describe('Get Deleted Musics', () => {
  ...
  beforeAll(async () => {
    ...
    await musicFactory.createBatch(10, (await userFactory.create('2')).id, true);
  ...
  it('get deleted musics with default query params', async () => {
  ...
  it('get deleted musics with explicit query params', async () => {
    const response = await request(app)
      .get('/musics/deleted?page=2&size=4')
      .set('Authorization', authorizationUser1);
  ...
  )('get deleted musics with inappropriate tokens', async (authorization, expectedMessage) => {
    const response = await request(app)
      .get('/musics/deleted')
  ...
  it('get deleted musics without authorization header', async () => {
    const response = await request(app)
      .get('/musics/deleted');
  ...
  it('get deleted musics without bearer authentication scheme', async () => {
    const response = await request(app)
      .get('/musics/deleted')
  ...
  it('get deleted musics with expired token', async () => {
    const response = await request(app)
      .get('/musics/deleted')
